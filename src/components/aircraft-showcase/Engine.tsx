...
import { ENGINE_SECTION } from "./constants";

/** Alternates image/content sides vs. Airframe/Cockpit — automotive-site convention. */
export function Engine() {
  const { id, camera, content, specifications } = ENGINE_SECTION;
