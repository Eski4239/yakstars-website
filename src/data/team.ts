...
export type Pilot = {
  ...
  /** Expanded-card content — see PilotCard. */
  story: string[];
  experience: string[];
  awards: string[];
};
...
export const pilots: Pilot[] = [
  {
    ...
    experience: ["20,000+ flight hours", "C-101 Aviojet, F-5A, Mirage F-1, F-18A, AV-8B Harrier II+, Yak-52"],
    awards: [
      "18+ years Spanish Air Force, 4 years Spanish Navy",
      "100+ aircraft-carrier landings",
      "Exchange tour, U.S. Marine Corps VMA-542",
  ...
  },
  {
    ...
    experience: ["20 years on the Yak-52", "Yak-52, Extra 300, Extra 330, Citation jets, radial-engine taildraggers"],
    awards: [
      "First civilian flight leader in team history (2022)",
      "CEVA gold — Sportsman & Intermediate",
      "Cascais Air Race — 2014, 2016, 2018",
  ...
  },
  {
    ...
    experience: ["1,000+ Yak-52 flights", "Yak-52 “Blue Devil”, Extra 300S, gliders, 20+ types flown"],
    awards: [
      "Aerospace engineering degree — MIT",
      "CEVA & Copa Triangular medals — Sportsman to Advanced",
      "1,000+ flights in the “Blue Devil”",
  ...
  },
  {
    ...
    experience: ["10,000+ flight hours", "Airbus A319/320/321, Boeing 737F, Pilatus P-3, Yak-52, 55 types"],
    awards: [
      "10,000+ flight hours",
      "Qualified on 55 aircraft types",
      "Firefighting & agricultural operations",
  ...
  },
  {
    ...
    experience: ["16,000+ flight hours", "Airbus A330/A350, Airbus A320, Yak-52, gliders"],
    awards: [
      "16,000+ flight hours",
      "A330/A350 Line Training Captain — Iberia",
      "27 years with Iberia",
  ...
  },
  {
    ...
    experience: ["19,500+ flight hours", "FIAT G-91, Alpha Jet, T-37/T-38, Airbus A320/A340, Yak-52, Antonov AN-2"],
    awards: [
      "19,500+ flight hours — 3,000+ in formation & low-level aerobatics",
      "Portuguese Air Force Academy & USAF pilot training",
      "Asas de Portugal — positions 3 and 5",
